...
$utilities = $proximaUtilidade->listar_mais_proximo("status_utilidade = 1 AND data_inicio >= '$recente'", "data_inicio ASC", "1");

if (!empty($utilities)) {
    echo json_encode([
        'status_utilidade' => 'success',
        'utilidade' => $utilities[0]
    ]);
} else {
    echo json_encode([
        'status_utilidade' => 'error',
