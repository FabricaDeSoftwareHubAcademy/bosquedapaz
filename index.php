...
$allowed_ips = [
    'fe80::756d:2022:8c78:1574%2' // IP permitido (substitua pelo IP correto)
];
...
if (filter_var($user_ip, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6)) {
    ...
    if (in_array($user_ip, $allowed_ips)) {
        // Se o IP for permitido, redireciona para a pasta desejada
        header('Location: Todos/'); // Caminho para a pasta onde estão suas telas
