...
<body>
    ...
    <main class="principal-tela-utl">
        ...
        <dialog class="modal-Ult" id="modal-card-Ult">
            ...
            <div class="div__decorativa-card2">
                <div class="linha_docorativa-modal1"></div>
                <div class="linha_docorativa-modal2"></div>
            </div>

            <button id="b-sari-modal" class="close-modal" data-modal="modal-card-Ult">
