...
<body>
    ...
    <section class="section-introducao-quem-somos">
        <div class="titulo-descricao-principal">
            ...
            <p class="descricao dark">Somos uma equipe movida pela paixão de conectar pessoas, inspirar encontros e
                promover a troca genuína de ideias e experiências. Desde nossa fundação, buscamos ir além da organização
                de eventos — queremos criar espaços vivos e acolhedores, onde expositores e visitantes se reconhecem,
                compartilham histórias e constroem oportunidades juntos. Cada detalhe é pensado para incentivar o
                diálogo, despertar a criatividade e tornar cada edição uma experiência única.

                Acreditamos que é na diversidade que surgem as conexões mais autênticas. Valorizamos cada voz e cada
                olhar, porque são essas diferenças que tornam nossos encontros verdadeiramente memoráveis.

            </p>
        </div>
    </section>

    <section class="section-imagens-flutuantes-quem-somos">
        <div class="titulo-nossa-historia-quem-somos">
            <h1 class="h1-secundario">A MAIOR FEIRA DE ECONOMIA CRIATIVA DE MS! </h1>
    ...
    <section class="texto-descricao-fluxo-quem-somos">
        <div class="descricao-fluxo">
            <p class="descricao2 dark">A recepção da população também supera as
                ...
                retornam com muitos elogios pessoalmente e pelas
                nossas redes sociais. Atualmente, a feira recebe em média 20.000 visitantes por edição.</p>
        </div>
    </section>
    ...
    <section class="section-nosso-time-quem-somos">
        <div class="div-nt">
            <h1 class="h1-terciário">NOSSO TIME</h1>
        </div>
    </section>
    ...
    <section class="section-colaboradoras-quem-somos">
        ...
        <div class="descricao-colaboradoras-quem-somos">
            <p class="descricao3 dark">Apaixonadas por conectar pessoas e criar experiências transformadoras, dedicamos
                nosso trabalho a tornar cada encontro único e significativo. Desde o início, o objetivo sempre foi ir
                além de um simples evento — criar um espaço vivo, diverso e inspirador, onde ideias, histórias e
                oportunidades se cruzam naturalmente.
            </p>
        </div>
    </section>
    ...
    <section class="section-expositor-quem-somos">
        ...
        <div class="div-botao">
            <a class="botao-expositor" href="escolher-cadastro.php">
                <div class="botao">
                    CLIQUE AQUI!
                </div>
            </a>
    ...
    <section class="section-descricao-expositor-quem-somos">
        <div class="expositor-p">
            <p class="descricao4 dark">Mostre todo o seu talento na nossa feira e conquiste o reconhecimento que você
                merece! Acesse o botão abaixo, faça seu cadastro agora mesmo e aproveite essa oportunidade única de
                apresentar seu trabalho para um público engajado e animado. Não deixe essa chance passar, destaque-se e
                faça parte desse grande evento!
            </p>
        </div>
    </section>

    <section class="section-fotos-expositor-quem-somos">
        <div class="titulo-veja-mais-fotos">
            <h1 class="h1-quinto">
                VEJA MAIS DO BOSQUE DA PAZ
            </h1>
        </div>
