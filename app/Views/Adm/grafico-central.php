      ...
      <div class="area-dados-feirantes">
        <div class="cards-feirantes">
          <div class="card">
            ...
            <div id="dadosQtdExpositores" class="dados">
          ...
          <div class="card">
            ...
            <div id="QtdExpositoresEspera" class="dados">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
            ...
            <div id="QtdeExpositoresPagantes" class="dados">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16">
            ...
            <div id="QtdExpositoresDevendo" class="dados">
