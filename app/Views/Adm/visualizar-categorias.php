                            ...
                            <div class="form-box">
                                ...
                                <div class="custom-select">
                                    ...
                                    <div id="seletor-cor" class="select-items">
                                        <div data-value="rgba(13, 72, 161, 0.30)"><div class="color-preview" style="background-color: rgba(13, 72, 161, 0.30);"></div> Cor 1</div>
                                        <div data-value="rgba(255, 183, 0, 0.30)"><div class="color-preview" style="background-color: rgba(255, 183, 0, 0.30);"></div> Cor 2</div>
                                        <div data-value="rgba(113, 9, 183, 0.30)"><div class="color-preview" style="background-color: rgba(113, 9, 183, 0.30);"></div> Cor 3</div>
                                        <div data-value="rgba(217, 3, 103, 0.30)"><div class="color-preview" style="background-color: rgba(217, 3, 103, 0.30);"></div> Cor 4</div>
                                        <div data-value="rgba(23, 128, 118, 0.30)"><div class="color-preview" style="background-color: rgba(23, 128, 118, 0.30);"></div> Cor 5</div>
                                        <div data-value="rgba(251, 84, 7, 0.30)"><div class="color-preview" style="background-color: rgba(251, 84, 7, 0.30);"></div> Cor 6</div>
                                        <div data-value="rgba(25, 169, 78, 0.3)"><div class="color-preview" style="background-color: rgba(25, 169, 78, 0.3);"></div> Cor 7</div>
                                        <div data-value="rgba(108, 88, 76, 0.30)"><div class="color-preview" style="background-color: rgba(108, 88, 76, 0.30);"></div> Cor 8</div>
                                        <div data-value="rgba(17, 112, 96, 0.3)"><div class="color-preview" style="background-color: rgba(17, 112, 96, 0.3);"></div> Cor 9</div>
                                    </div>
                                </div>
