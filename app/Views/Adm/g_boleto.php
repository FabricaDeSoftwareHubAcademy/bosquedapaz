    ...
    <div class="box-all">
        ...
        <section class="area-filtro-de-dados">
            ...
            <div class="filtrar-por-status">
                <label for="">Pesquisar por Status</label>
            ...
            <table class="table-tabela-de-dados">
                ...
                <tbody class="tbody-tabela-de-dados">
                    <tr class="tr-tabela-de-dados">
                        ...
                        <td class="td-tabela-de-dados">Pago</td>
                    </tr>
                    <tr class="tr-tabela-de-dados">
                        ...
                        <td class="td-tabela-de-dados">Em aberto</td>
                    </tr>
                    <tr class="tr-tabela-de-dados">
                        ...
                        <td class="td-tabela-de-dados">Atrasado</td>
                    </tr>
                    <tr class="tr-tabela-de-dados">
                    ...
                    <tr class="tr-tabela-de-dados">
                        ...
                        <td class="td-tabela-de-dados">Agendado</td>
                    </tr>
                    <tr class="tr-tabela-de-dados">
