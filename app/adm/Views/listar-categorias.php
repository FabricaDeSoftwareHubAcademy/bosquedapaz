                    ...
                    <div class="table-container">
                        <table class="collaborators-table">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td class="usuario-col"><?php echo $categoria->id_categoria ?></td>
                                        ...
                                        <td>
                                            <a href="#"
                                                ...
                                                data-nome="<?php echo htmlspecialchars($categoria->descricao, ENT_QUOTES); ?>"
                                                data-cor="<?php echo $categoria->cor; ?>">
