    ...
    <main class="container__main">
        ...
        <div class="container__box">
            ...
            <div class="container__action__tile">
                ...
                <!-- aqui -->
                <div class="container__action open-modal" data-modal="abrir-mais-expositor">
                    <div class="area__action">
                ...
                <!-- aqui -->
                <div class="container__action open-modal" data-modal="abrir-mais-categoria">
                    <div class="area__action">
            ...
            <!-- Modal Eventos -->
                ...
                <!-- aqui -->
                <div class="container__action open-modal" data-modal="abrir-mais-gerancia">
                    <div class="area__action">
